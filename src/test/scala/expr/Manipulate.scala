...
class SimplifyTest extends FunSuite {
	...
	val expected = Map[String,String](
		...
		"-1*(2*a*b+3*a*c)/a" -> "(-2.0)*b-3.0*c",
		"4.0*(sin(theta)^5.0+2.0*sin(theta)^6.0)/sin(theta)" -> "8.0*sin(theta)^5.0+4.0*sin(theta)^4.0",
		"4.0*(sin(theta)^5.0+2.0*sin(theta)^6.0)/sin(theta)^2" -> "8.0*sin(theta)^4.0+4.0*sin(theta)^3.0",
